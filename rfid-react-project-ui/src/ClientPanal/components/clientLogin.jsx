...
const ClientLogin = () => {
  ...
  return (
    ...
    <div className="text-center mt-4">
      <h3 className="text-2xl font-semibold mb-4">Welcome to client</h3>
      <p className="text-sm text-gray-500">We are happy to have you back</p>
          ...
          <div className="my-4 text-center">
            ...
            <p className="text-sm mt-4">Don't have an account? <a href="/clientregister" className="text-blue-600">Register</a></p>
          </div>
        </div>
      </div>
