      ...
      <div className="w-1/2 flex justify-center items-center bg-white p-8">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mt-4">
            <h3 className="text-2xl font-semibold mb-4">Wellcome To User Register👋</h3>
          ...
          <div className="my-4 text-center">
            ...
            <p className="text-sm mt-4">Already have an account? <a href="/UserLogin" className="text-blue-600">Login</a></p>
          </div>
        </div>
      </div>
